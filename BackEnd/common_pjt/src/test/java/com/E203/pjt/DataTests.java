 ...
 //            em.persist(u);
             User u = userRepository.findByUserSeq(i);
             for (int j=1; j<6; j++) {
                 PartyReqVO partyReqVO = new PartyReqVO();
                 partyReqVO.setUserSeq(u.getUserSeq());
                 partyReqVO.setPartyCode(String.format("00%d", j%3+1));
                 ...
                 partyReqVO.setPartyMainImageUrl("assets/images/harry.png");
 ...
 //        em.clear();
     ...
     void makeBookmark() {
         for (int i=1; i<5; i++) {
             ...
             bookmarkReqVO.setUserSeq(i);
             bookmarkReqVO.setPartySeq(j);
 ...
 //        Party party = partyRepository.findByPartySeq(1);
     ...
     void checkListPartyHost() {
         ...
         for (PartyResVO partyResVO : result) {
